...
public class MainActivity extends AppCompatActivity {
    ...
    Button startButton, button3, button1, button2, button4, playAgainButton;
        ...
        if (counterIsActive == true) {
            ...
            new CountDownTimer(30100, 1000) {
                ...
                public void onFinish() {
                    ...
                    resultTextView.setText("Youe score : " + Integer.toString(score) + "/" + Integer.toString(numberOfQuestion));
